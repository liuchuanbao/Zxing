...
final class BitMatrixParser {
   ...
   * datamatrix代码。< / p >
   *
   * < p >看到ISO 16022:2006表7 - ECC 200符号属性< / p >
   *
   * bitMatrix原始{ @link bitMatrix }包括校准模式
   * @return } { @link版本封装数据矩阵代码的“版本”
   * FormatException如果映射矩阵的尺寸不是有效的
   *数据矩阵维度。
   *
   ...
   * Data Matrix Code.</p>
   *在{ < p >读取位@link BitMatrix }代表映射矩阵(没有对齐模式)
   *以正确的顺序,以便重建中包含的字节码字
   *数据矩阵代码。< / p
