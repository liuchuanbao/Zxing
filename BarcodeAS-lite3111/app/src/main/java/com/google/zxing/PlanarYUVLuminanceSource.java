...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
  ...
  public byte[] getRow(int y, byte[] row) {
    ...
    Log.e("xyc","PlanarYUVLuminanceSource= getRow "+row.toString());
  ...
  public byte[] getMatrix() {
    ...
    if (width == dataWidth) {
      ...
      Log.e("xyc","PlanarYUVLuminanceSource= getRow "+matrix.toString());
      return matrix;
    }
    ...
    Log.e("xyc","PlanarYUVLuminanceSource= getRow "+yuvData.toString());
    return matrix;
  }
