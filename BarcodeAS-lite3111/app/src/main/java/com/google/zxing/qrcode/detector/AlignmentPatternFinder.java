 ...
 *这个类二维码试图找到校准模式。像仪校准模式
 定期*模式但规模较小,似乎整个形象。< / p >
 *
 * < p >目前这只寻找右下方的对齐模式。< / p >
 *
 * < p >这是一个简化的副本{ @link FinderPatternFinder }。这是复制,
 *粘贴和剥夺了这里最大的性能,但不幸的是重复的
 *一些代码。< / p >
 *
...
final class AlignmentPatternFinder {
   ...
   *这叫做水平扫描时发现了一个可能的排列模式。它将
   与垂直扫描*交叉检查,如果成功,将会看到如果这种模式
   *上发现一个以前的水平扫描。如果是这样,我们认为这是证实我们已经结束
   *发现校准模式。< / p >
