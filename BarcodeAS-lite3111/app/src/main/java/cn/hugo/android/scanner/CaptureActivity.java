...
public final class CaptureActivity extends Activity implements
	...
	public void onMessageEvent(DecodeImageData_Result event) {
		finish();
	};
...
//    显示 扫描框
					...
					new Thread(new Runnable() {
						...
						public void run() {
							...
							Log.e("xyc","CaptureActivity  Result "+ result);
							if (result != null) {
	 ...
	 */
	public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {//解析成功时回调
		...
		Log.e("xyc","CaptureActivity handleDecode  rawResult ==="+rawResult.toString());
		Toast.makeText(this,
	...
	public void onClick(View v) {
		switch (v.getId()) {
			case R.id.capture_scan_photo: // "图片识别"按钮被点击
				// 打开手机中的相册
			...
			case R.id.capture_flashlight:  // "闪光灯"按钮被点击
				if (isFlashlightOpen) {
