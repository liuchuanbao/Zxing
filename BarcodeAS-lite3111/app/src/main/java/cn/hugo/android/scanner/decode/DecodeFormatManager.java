	...
	private static Collection<BarcodeFormat> parseDecodeFormats(
		...
		if (decodeMode != null) {
			if (Intents.Scan.PRODUCT_MODE.equals(decodeMode)) {
				...
				Log.e("xyc","DecodeFormatManager = 1 PRODUCT_FORMATS");
				return PRODUCT_FORMATS;
			}
			if (Intents.Scan.QR_CODE_MODE.equals(decodeMode)) {
				Log.e("xyc","DecodeFormatManager = 2 QR_CODE_FORMATS");
				return QR_CODE_FORMATS;
			}
			if (Intents.Scan.DATA_MATRIX_MODE.equals(decodeMode)) {
				Log.e("xyc","DecodeFormatManager = 3 DATA_MATRIX_FORMATS");
				return DATA_MATRIX_FORMATS;
			}
			if (Intents.Scan.ONE_D_MODE.equals(decodeMode)) {

				Log.e("xyc","DecodeFormatManager = 4 ONE_D_FORMATS");
